...
class SimpleMark(QMainWindow):
    ...
    def __init__(self):
        ...
        self.image_number = 0  # номер текущего изображения
    ...
    def toPreviousImage(self):
        self.image_number -= 1
        if not self.toImageByNumber(self.image_number):
            self.image_number += 1
        self.setFocus()
    ...
    def initUI(self):
        ...
        previous_button.setIcon(QtGui.QIcon(".venv/Images/pointer_left.png"))
        ...
        next_button.setIcon(QtGui.QIcon(".venv/Images/pointer_right.png"))
        ...
        self.setFocus()
        self.setImage(self.getImage(".venv/Images/Gvin.jfif"))
